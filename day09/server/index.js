...
const selectFunc = require(path.join(__dirname, '../ex04', 'select.js')).selectFunc;
const insertFunc = require(path.join(__dirname, '../ex04', 'insert.js')).insertFunc;
const deleteFunc = require(path.join(__dirname, '../ex04', 'delete.js')).deleteFunc;
...
app.get('/ex00/ballon.html', (req, res) => {
    res.sendFile(path.join(__dirname, '../ex00', 'ballon.html'));
});
...
app.get('/ex03/ex00bis/ballon.html', (req, res) => {
    res.sendFile(path.join(__dirname, '../ex03/ex00bis', 'ballon.html'));
});
